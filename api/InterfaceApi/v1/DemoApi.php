...
use MsPro\Annotation\Api\MApi;
use MsPro\Annotation\Api\MApiRequestParam;
use MsPro\Annotation\Api\MApiResponseParam;
...
class DemoApi
{
    ...
    {
        $this->response = container()->get(MsProResponse::class);
        $this->user = $user;
        $this->dept = $dept;
    }
