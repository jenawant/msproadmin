...
return [
    ...
    'servers' => [
        [
            ...
            'callbacks' => [
                Event::ON_REQUEST => [MsProServer::class, 'onRequest'],
            ],
        ],
        [
            'name' => 'message',
            ...
            'host' => '0.0.0.0',
            'port' => (int)env('MESSAGE_SERVER_PORT', 9502),
            'sock_type' => SWOOLE_SOCK_TCP,
            'callbacks' => [
    ...
    'callbacks' => [
        Event::ON_BEFORE_START => [MsPro\MsProStart::class, 'beforeStart'],
